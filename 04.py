...
print("*" * 80)
print("Advent of Code 2022 - Day 4: Scratchcards")
print("*" * 80)
"""
--- Day 4: Scratchcards ---
...
for line in lines:
    ...
    numbers = set(
        line.split(":")[1].split("|")[1].strip().replace("  ", " ").split(" ")
    )
    wins = len(winning_numbers & numbers)
    points = 0 if wins == 0 else pow(2, wins - 1)
    total_points += points
    # print(points)


print(f"In total they are worth {total_points} points.")
...
print(f"You end up with {sum(scratchcards)} scratchcards.")
